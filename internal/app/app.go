...
import (
	...
	"github.com/sauravmarvani/nextcode/internal/update"
...
type App struct {
	...
	// subscribers (notably `nextcode run` in client/server mode) can
...
// for `nextcode run`. A lossy fan-in here can drop the only terminal
