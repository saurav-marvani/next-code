...
nextcode update-providers https://example.com/providers.json
...
nextcode update-providers --source=hyper

# Update Hyper from a custom URL
nextcode update-providers --source=hyper https://hyper.example.com
`,
