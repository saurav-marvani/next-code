...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "nextcode.log")
...
func TestNewNextCodeLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewNextCodeLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, NextCodeLogsToolName, tool.Info().Name)
}

func TestNextCodeLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 3})
...
func TestNextCodeLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 0})
...
func TestNextCodeLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestNextCodeLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runNextCodeLogs("/nonexistent/path/nextcode.log", NextCodeLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestNextCodeLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "nextcode.log")
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestNextCodeLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "nextcode.log")
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 10})
...
func TestNextCodeLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 1})
...
func TestNextCodeLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestNextCodeLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestNextCodeLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestNextCodeLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "nextcode.log")
...
func TestNextCodeLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "nextcode.log")
...
func TestNextCodeLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestNextCodeLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestNextCodeLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestNextCodeLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runNextCodeLogs(logFile, NextCodeLogsParams{Lines: 5})
...
func TestNextCodeLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
