...
//go:embed nextcode_info.md
var nextcodeInfoDescription string

type NextCodeInfoParams struct{}

func NewNextCodeInfoTool(
	...
	return fantasy.NewAgentTool(
		NextCodeInfoToolName,
		nextcodeInfoDescription,
		func(ctx context.Context, _ NextCodeInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildNextCodeInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildNextCodeInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
