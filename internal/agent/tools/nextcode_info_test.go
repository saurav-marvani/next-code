...
func TestNextCodeInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildNextCodeInfo(cfg, nil, nil, nil, nil)
...
func TestNextCodeInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/nextcode/nextcode.json",
		"/project/.nextcode/nextcode.json",
	)
	output := buildNextCodeInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/nextcode/nextcode.json")
	require.Contains(t, output, "/project/.nextcode/nextcode.json")
}

func TestNextCodeInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildNextCodeInfo(cfg, mgr, nil, nil, nil)
...
func TestNextCodeInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.nextcode",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.nextcode")
	require.Contains(t, output, "debug = true")
}

func TestNextCodeInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildNextCodeInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildNextCodeInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestNextCodeInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()
	...
	output := buildNextCodeInfo(store, nil, nil, nil, nil)
...
func TestNextCodeInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "nextcode-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("nextcode-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildNextCodeInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "nextcode-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestNextCodeInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "nextcode-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestNextCodeInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestNextCodeInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
