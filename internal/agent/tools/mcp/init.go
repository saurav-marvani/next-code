...
// isTokenRefreshErr returns true if the error indicates the OAuth
// refresh token is no longer valid (expired, revoked, or otherwise
// rejected by the authorization server). This covers the common case
